...
public final class InteractorNotifyMessage_Factory<V extends InterfaceViewNotifyMessage> implements Factory<InteractorNotifyMessage<V>> {
  ...
  public InteractorNotifyMessage_Factory(Provider<FragmentManager> supportFragmentProvider,
  ...
  public static <V extends InterfaceViewNotifyMessage> InteractorNotifyMessage_Factory<V> create(
    ...
    return new InteractorNotifyMessage_Factory<V>(supportFragmentProvider, contextProvider, firebaseProvider);
  }

  public static <V extends InterfaceViewNotifyMessage> InteractorNotifyMessage<V> newInstance(
      FragmentManager supportFragment, Context context, InterfaceFirebase firebase) {
    return new InteractorNotifyMessage<V>(supportFragment, context, firebase);
  }
}
